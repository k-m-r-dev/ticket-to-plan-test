...
Full SPEC integration coverage using Axum `TestClient` / tower service tests; clippy clean; ready for human-approved milestone commit.
...
- **Inputs:** SPEC required test scenarios
...
- **Outputs:** Clippy-clean project; README with env vars and curl examples (optional, not scored)
