# Benchmark prompt — protocol `abp-v1` arm `no-tools` fixture `f1` r2

## Instructions

Follow skills/ticket-to-plan-no-tools/SKILL.md. Write plans only under this run's artifacts/. Do not implement.
...
Write plan artifacts into `benchmark/runs/abp-v1/f1/no-tools/r2/artifacts/`.
