# Benchmark prompt — protocol `abp-v1` arm `openspec` fixture `f1` r1

## Instructions

Follow skills/ticket-to-plan-openspec/SKILL.md with OpenSpec. Stop at plan-ready; do not implement.
...
Write plan artifacts into `benchmark/runs/abp-v1/f1/openspec/r1/artifacts/`.
