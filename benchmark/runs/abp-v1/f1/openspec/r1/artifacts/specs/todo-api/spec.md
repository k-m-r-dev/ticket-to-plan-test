...
Defines the locked HTTP behavior for a local Todo API: CRUD, completion filter, health check, SQLite persistence, and a shared JSON error envelope for clients and integration tests.
