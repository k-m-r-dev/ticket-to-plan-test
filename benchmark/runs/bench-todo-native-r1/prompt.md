# Benchmark prompt — arm `native`

## Instructions

No ticket-to-plan skill. Produce a complete implementation plan for the SPEC below. Write the plan markdown into this run's artifacts/. Do not implement code.

## Skill path

(none — native planning)

## Output

Copy or write final plan artifacts into `benchmark/runs/bench-todo-native-r1/artifacts/`.
