# Benchmark prompt — arm `gsd`

## Instructions

Follow skills/ticket-to-plan-gsd/SKILL.md with GSD workflow MCP. Scope is fully specified — skip grilling. Stop at plan-ready; do not implement.
...
Copy or write final plan artifacts into `benchmark/runs/bench-todo-gsd-r1/artifacts/`.
