# Benchmark prompt — arm `openspec`

## Instructions

Follow skills/ticket-to-plan-openspec/SKILL.md with OpenSpec (npx openspec / /opsx-*). Scope is fully specified — skip grilling. Stop at plan-ready; do not implement.

## Skill path

skills/ticket-to-plan-openspec/SKILL.md

## Output

Copy or write final plan artifacts into `benchmark/runs/bench-todo-openspec-r1/artifacts/`.
